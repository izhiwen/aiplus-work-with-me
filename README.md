...
`aiplus-work-with-you` is a **template repository** for that profile bundle.
...
git clone https://github.com/<your-account>/aiplus-work-with-you.git
cd aiplus-work-with-you
...
`aiplus-work-with-you` is the user-profile bundle layer. It composes with:
...
gh repo fork izhiwen/aiplus-work-with-you --clone --fork-name aiplus-work-with-<your-name>
