...
`aiplus-work-with-you` 就是这份 profile bundle 的**模板仓库**。你 fork 一份、
...
`aiplus-work-with-you` 是 user-profile bundle 层。它与以下模块组合使用：
...
gh repo fork izhiwen/aiplus-work-with-you --clone --fork-name aiplus-work-with-<你的名字>
