...
inherits = ["aiplus-work-with-you when linked and available"]  # Parent profiles
```
...
- Any file containing `aiplus-work-with-you` specific preferences

### Allowed in Public Assets

- Generic references: "Private profiles such as `aiplus-work-with-you` may consume this engine"
- Template `inherits = ["aiplus-work-with-you when linked and available"]`
- `forbidden_files: [aiplus-work-with-you private content, any writes]`
...
1. **Source repo backup**: The profile source in `aiplus-work-with-you/` is the source of truth. Keep it in version control.
2. **Installed profile backup**: `~/.config/aiplus/profiles/aiplus-work-with-you/` can be backed up as a tarball.
